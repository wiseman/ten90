...
LDFLAGS = 
LIBOBJS = 
LIBRTLSDR_CFLAGS = -I/usr/local/include/ -I/usr/include/libusb-1.0  
LIBRTLSDR_LIBS = -L/usr/local/lib -lrtlsdr -lusb-1.0  
LIBS =  -L/usr/local/lib -lrtlsdr -lusb-1.0   -lpthread -lm
